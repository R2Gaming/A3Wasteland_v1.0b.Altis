...
[
	["Vehicle Ammo Crate", "Box_NATO_AmmoVeh_F", 250000],
...
[
	...
	["UAV Terminal (NATO)", "B_UavTerminal", 15000, "gps"],
	["UAV Terminal (CSAT)", "O_UavTerminal", 15000, "gps"],
	["UAV Terminal (AAF)", "I_UavTerminal", 15000, "gps"],
	["GPS", "ItemGPS", 100, "gps"],
...
[
	...
	["SUV", "C_SUV_01_F", 11000, "vehicle"],
	["Offroad", "C_Offroad_01_F", 11000, "vehicle"],
	["Offroad Camo", "B_G_Offroad_01_F", 12500, "vehicle"],
	["Offroad Repair", "C_Offroad_01_repair_F", 15000, "vehicle"],
	["Offroad HMG", "B_G_Offroad_01_armed_F", 25000, "vehicle"],

	["Truck", "C_Van_01_transport_F", 7000, "vehicle"],
	["Truck (Camo)", "B_G_Van_01_transport_F", 8000, "vehicle"],
	["Truck Box", "C_Van_01_box_F", 9000, "vehicle"],
	["Fuel Truck", "C_Van_01_fuel_F", 20000, "vehicle"],
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 21000, "vehicle"],
	...
	["HEMTT Covered", "B_Truck_01_covered_F", 75000, "vehicle"],
	["HEMTT Fuel", "B_Truck_01_fuel_F", 90000, "vehicle"],
	["HEMTT Medical", "B_Truck_01_medical_F", 100000, "vehicle"],
	["HEMTT Repair", "B_Truck_01_Repair_F", 125000, "vehicle"],
	["HEMTT Ammo", "B_Truck_01_ammo_F", 275000, "vehicle"],

	["Tempest Device", "O_Truck_03_device_F", 40000, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 60000, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 75000, "vehicle"],
	["Tempest Fuel", "O_Truck_03_fuel_F", 90000, "vehicle"],
	["Tempest Medical", "O_Truck_03_medical_F", 100000, "vehicle"],
	["Tempest Repair", "O_Truck_03_repair_F", 125000, "vehicle"],
	["Tempest Ammo", "O_Truck_03_ammo_F", 275000, "vehicle"],

	["Zamak Transport", "I_Truck_02_transport_F", 40000, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 50000, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 75000, "vehicle"],
	["Zamak Medical", "I_Truck_02_medical_F", 90000, "vehicle"],
	["Zamak Repair", "I_Truck_02_box_F", 100000, "vehicle"],
...
[
	["CRV-6e Bobcat", "B_APC_Tracked_01_CRV_F", 325000, "vehicle"],
...
[
	...
	["PO-30 Orca (Black)", "O_Heli_Light_02_unarmed_F", 70000, "vehicle"], // Ka-60
	["WY-55 Hellcat (Green)", "I_Heli_light_03_unarmed_F", 70000, "vehicle"], // AW159

	["Mi-290 Taru (Crane) [DLC]", "O_Heli_Transport_04_F", 75000, "vehicle"], // CH-54
	["Mi-290 Taru (Box) [DLC]", "O_Heli_Transport_04_box_F", 80000, "vehicle"],
	["Mi-290 Taru (Fuel) [DLC]", "O_Heli_Transport_04_fuel_F", 85000, "vehicle"],
	["Mi-290 Taru (Bench) [DLC]", "O_Heli_Transport_04_bench_F", 90000, "vehicle"],
	["Mi-290 Taru (Transport) [DLC]", "O_Heli_Transport_04_covered_F", 95000, "vehicle"],
	["CH-67 Huron (Black) [DLC]", "B_Heli_Transport_03_unarmed_F", 100000, "vehicle"], // CH-47
	...
	["Mi-290 Taru (Repair) [DLC]", "O_Heli_Transport_04_repair_F", 150000, "vehicle"],
	["Mi-290 Taru (Ammo) [DLC]", "O_Heli_Transport_04_ammo_F", 250000, "vehicle"],

	["UH-80 Ghost Hawk (Black)", "B_Heli_Transport_01_F", 250000, "vehicle"], // UH-60 Stealth with 2 side miniguns
	["UH-80 Ghost Hawk (Green)", "B_Heli_Transport_01_camo_F", 250000, "vehicle"], // UH-60 Stealth with 2 side miniguns (green camo)
	["CH-67 Huron (Armed) [DLC]", "B_Heli_Transport_03_F", 300000, "vehicle"], // CH-47 with 2 side miniguns
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 300000, "vehicle"], // Armed AH-6
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 300000, "vehicle"], // Armed Ka-60 with orca paintjob
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 350000, "vehicle"], // Armed Ka-60
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 400000, "vehicle"], // Armed AW159
	...
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 600000, "vehicle"] // Mi-28 with gunner (black camo)
];

planesArray = compileFinal str
[
	["A-143 Buzzard AA", "I_Plane_Fighter_03_AA_F", 400000, "vehicle"],
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 450000, "vehicle"],
...
[
	["Rescue Boat", "C_Rubberboat", 5000, "boat"],
	["Rescue Boat (NATO)", "B_Lifeboat", 5000, "boat"],
	["Rescue Boat (CSAT)", "O_Lifeboat", 5000, "boat"],
	["Assault Boat (NATO)", "B_Boat_Transport_01_F", 6000, "boat"],
	["Assault Boat (CSAT)", "O_Boat_Transport_01_F", 6000, "boat"],
	["Assault Boat (AAF)", "I_Boat_Transport_01_F", 6000, "boat"],
	["Assault Boat (FIA)", "B_G_Boat_Transport_01_F", 6000, "boat"],
	["Motorboat", "C_Boat_Civil_01_F", 10000, "boat"],
	["Motorboat Rescue", "C_Boat_Civil_rescue_01_F", 9000, "boat"],
	["Motorboat Police", "C_Boat_Civil_police_01_F", 12500, "boat"],
	...
	["SDV Submarine (NATO)", "B_SDV_01_F", 10000, "submarine"],
